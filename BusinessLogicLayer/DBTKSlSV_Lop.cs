...
namespace BusinessLogicLayer
{
    public class DBTKSlSV_Lop
    {
        ...
        // Phương thức để lấy dữ liệu biểu đồ số lượng sinh viên theo lớp
        public DataTable GetChartDataSLSV_Lop()
        {
            return db.GetChartDataSLSV_Lop(); // Trả về dữ liệu từ cơ sở dữ liệu cho biểu đồ số lượng sinh viên theo lớp
        }
