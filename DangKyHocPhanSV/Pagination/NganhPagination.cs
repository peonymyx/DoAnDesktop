    ...
    public class NganhPagination
    {
            ...
            public async Task<IPagedList<Nganh>> GetPagedListAsync(int pageNumber = 1, int pageSize = 5)
            {
                ...
                using (MySqlConnection connection = new MySqlConnection(connectionString))
                {
                    ...
                    DataTable dataTable = dsNganh.DanhSachNganh().Tables[0];
                    ...
                    List<Nganh> nganh = rows.Select(row => new Nganh
                    {
                    ...
                    list = new StaticPagedList<Nganh>(
                        nganh, pageNumber, pageSize, totalRecords);
