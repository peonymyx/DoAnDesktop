...
namespace DangKyHocPhanSV
{
    public partial class FrmDanhSachLopHocGV : Form
    {
        ...
        public FrmDanhSachLopHocGV(Panel panelContainer, Panel panelHeader)
        {
            InitializeComponent();
            lh.GiangVienConnect();
            gv.GiangVienConnect();
        ...
        private void btn_vaohoc_Click(object sender, EventArgs e)
        {
            ...
            ((FrmTrangGiangVien)this.ParentForm).OpenChildForm(new FrmLopHocGV(lophoc.MaLopHoc, _panelContainer, _panelHeader, maso), _panelContainer);
        }
