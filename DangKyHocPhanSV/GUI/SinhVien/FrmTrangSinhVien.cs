...
namespace DangKyHocPhanSV
{
    public partial class FrmTrangSinhVien : Form
    {
        ...
        {
            FrmDangKyMonHoc dk = new FrmDangKyMonHoc(pn_header);
            dk.MaSo = maso;
        ...
        {
            FrmThoiKhoaBieuSV tkb = new FrmThoiKhoaBieuSV(pn_header);
            tkb.MaSo = maso;
        ...
        {
            FrmTraCuuMonHoc tcmh = new FrmTraCuuMonHoc(pn_header);
        ...
        {
            FrmDanhSachLopHocSV ds = new FrmDanhSachLopHocSV(pn_container, pn_header);
            ds.MaSo = maso;
