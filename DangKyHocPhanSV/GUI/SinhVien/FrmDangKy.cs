...
namespace DangKyHocPhanSV
{
    public partial class FrmDangKy : Form
    {
        ...
        public FrmDangKy(Panel panelMonhoc, string maso, string mamh)
        {
            InitializeComponent();
            ...
            _panelMonhoc = panelMonhoc; // Gán panel nhận được từ tham số cho biến panel của form
        ...
        private void btn_quaylai_Click(object sender, EventArgs e)
        {
            ...
            _panelMonhoc.Show(); // Hiển thị lại panel chính
        }
